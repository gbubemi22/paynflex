...
export const create = async (userId, pin) => {
...
export const initiateResetPin = async (identifier, method) => {
...
export const verifyPinRest = async (identifier, otp, pin) => {
    ...
    await User.findOneAndUpdate({ _id: otpRecord._id }, { $set: { otp: null, expired_at: null } });

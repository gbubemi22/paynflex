...
export declare const login: (phoneNumber: string, email: string, password: string, deviceToken: string, deviceName: string, deviceType: string) => Promise<{
    success: boolean;
    message: string;
    user: {
        id: unknown;
...
export declare const code: (userId: string) => Promise<{
    status: boolean;
    message: string;
    data: string | undefined;
}>;
export declare const updateProfile: (userId: string, image: string) => Promise<{
    status: boolean;
    message: string;

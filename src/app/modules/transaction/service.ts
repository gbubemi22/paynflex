...
export const listTrx = async (userId: string) => {
...
export const listOne = async (transactionId: string, userId: string) => {
...
export const getYearlyTransactionSummary = async (
  userId: string,
  year?: number
) => {
  try {
    ...
    const yearlyTotal = completeMonthly.reduce(
      (acc, month) => ({
    ...
    throw new BadRequestError(
      "Unable to fetch yearly transaction summary. Ensure your inputs are valid."
    );
  }
};

...
import Product, { ProductDataType, UpdateProductData } from "./model.js";
...
export const update = async (id: string, payload: UpdateProductData) => {
  ...
  const updateData: Partial<UpdateProductData> = { ...payload };
